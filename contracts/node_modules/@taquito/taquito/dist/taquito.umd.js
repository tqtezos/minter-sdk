                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            else if (this.chainId === exports.ChainIds.CARTHAGENET) {
                                lambdaAddress = exports.DefaultLambdaAddresses.CARTHAGENET;
                            }
                            else if (this.chainId === exports.ChainIds.DELPHINET) {
                                lambdaAddress = exports.DefaultLambdaAddresses.DELPHINET;
                            }
