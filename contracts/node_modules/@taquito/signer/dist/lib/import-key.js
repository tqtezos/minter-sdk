...
var taquito_signer_1 = require("./taquito-signer");
/**
 *
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    signer = taquito_signer_1.InMemorySigner.fromFundraiser(privateKeyOrEmail, passphrase, mnemonic);
                ...
                case 8: return [4 /*yield*/, taquito_signer_1.InMemorySigner.fromSecretKey(privateKeyOrEmail, passphrase)];
                case 9:
                    signer = _a.sent();
                    toolkit.setProvider({ signer: signer });
                    _a.label = 10;
