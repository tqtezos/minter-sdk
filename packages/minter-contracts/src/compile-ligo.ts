...
const compileSources: CompileSourceEntry[] = [
  ...
  {
    srcFile: 'swaps/fa2_allowlisted_swap_offchain_nocounter.mligo',
    mainFn: 'allowlisted_swaps_offchain_main',
    dstFile: 'fa2_allowlisted_swap_offchain_nocounter.tz',
    contract: true,
  },
  {
  ...
  {
    srcFile: 'swaps/fa2_swap_offchain_burn_fee.mligo',
    mainFn: 'allowlisted_swaps_offchain_main',
    dstFile: 'fa2_swap_offchain_burn_fee.tz',
    contract: true,
  },
  {
  ...
  {
    srcFile: 'fixed_price_sale/fixed_price_sale_market_tez_offchain_nocounter.mligo',
    mainFn: 'fixed_price_sale_permit_main',
    dstFile: 'fixed_price_sale_market_tez_offchain_nocounter.tz',
    contract: true,
  },
  {
  ...
  {
    srcFile: 'english_auction/english_auction_tez_allowlisted_token_cancel_only_admin.mligo',
    mainFn: 'english_auction_tez_main',
  ...
  {
    srcFile: 'minter_collection/nft/fa2_multi_nft_asset_simple_admin_global_operator.mligo',
    mainFn: 'nft_asset_main',
