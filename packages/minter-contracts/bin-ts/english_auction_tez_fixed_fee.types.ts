...
export type EnglishAuctionTezFixedFeeContractType = { methods: Methods, storage: Storage, code: { __type: 'EnglishAuctionTezFixedFeeCode', protocol: string, code: object[] } };
