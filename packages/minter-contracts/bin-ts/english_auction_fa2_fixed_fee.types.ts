...
export type EnglishAuctionFa2FixedFeeContractType = { methods: Methods, storage: Storage, code: { __type: 'EnglishAuctionFa2FixedFeeCode', protocol: string, code: object[] } };
