...
export type EnglishAuctionTezPermitAllowlistedContractType = { methods: Methods, storage: Storage, code: { __type: 'EnglishAuctionTezPermitAllowlistedCode', protocol: string, code: object[] } };
